# Supongamos que una Universidad desea estudiar la diferencia entre las 
# calificaciones finales de hombres y mujeres que rinden una asignatura inicial 
# de programación por primera vez. Para ello, disponen de las notas (en escala 
# de 1,0 a 7,0) de 27 hombres y 19 mujeres

# se ha decidido usar bootstrapping para la prueba de hipótesis, con un nivel 
# de significación α = 0, 05 y B = 9999 repeticiones.
...
# CONCLUSIÓN
# Al construir el intervalo de confianza mediante el método BCa para la 
# distribución bootstrap, R nos entrega como resultado el intervalo 
# (−2,372;−0,894). En consecuencia, concluimos con 95% de confianza que las 
# mujeres tienen, en promedio, mejor calificación final que los hombres, con 
# una diferencia de entre 0,894 y 2,372 puntos.
