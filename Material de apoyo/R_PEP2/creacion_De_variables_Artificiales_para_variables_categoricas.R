...
# para usar la variable categórica como predictor, 
# agregamos al modelo todas las variables artificiales creadas a partir de ella
m1 <- lm(valor ~ sexo + tipo, datos) print(m1)
